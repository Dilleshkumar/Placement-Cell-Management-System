...
echo $name;
        ...
        $insert = $db->query("update student set pdf=('$pdfContent') where s_id=('$name')");
        if($insert){
...
<form action="uploadpdf.php" method="post" enctype="multipart/form-data" style="margin-top:148px;
						margin-left:582px;">
