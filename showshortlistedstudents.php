...
$sql = "SELECT S.s_id,S.job_id from short_listed_students as S,jobs as J  where J.job_id=S.job_id";
		...
		<tfoot>
			<tr>
				...
				<div class="inner" style="margin-top: 34px;
					...
					<ul class="actions">
						<li><a href="#one" class="button big scrolly">Place</a></li>
					</ul>
				</div>
			</section>
...
//echo $name;
$date = date('Y-m-d');
$res= mysqli_query($con,"Select * from short_listed_students where s_id = '".$s_id."' and job_id = '".$job_id."'") or die(mysqli_error($con));
$check = mysqli_fetch_array($res);
if(isset($check))
{
	$res = mysqli_query($con,"Insert into placements(s_id,job_id) values ('$s_id','$job_id')");
	$_SESSION['success']="Placed successfully";
...
">Place Student</p>
					<div class="row" align="center">
						<div class="col-md-2">
						<form action="showshortlistedstudents.php" method="POST" style="margin-left: 660px;">
							...
							<h4 style="color:red;"><?php if( isset($_SESSION['Error']) )
{
        ...
        unset($_SESSION['Error']);
							...
							<input type="text" id="userName" class="form-control input-sm chat-input" name='job_id' placeholder="JobID" required  style="padding-left: 45px;"/>
							</br>
